    ...
    <div v-if="alarm.logMessage" class="feather-row">
      <div class="feather-col-12">
        <div class="card">
          ...
          <div v-html="DOMPurify.sanitize(alarm.logMessage)" class="card__body"></div>
        </div>
      </div>
    </div>
    ...
    <div v-if="alarm.description" class="feather-row">
      <div class="feather-col-12">
        <div class="card">
          ...
          <!-- eslint-disable-next-line vue/no-v-html -->
          <div v-html="DOMPurify.sanitize(alarm.description)" class="card__body"></div>
        </div>
      </div>
    </div>
    ...
    <div v-if="alarm.operatorInstructions" class="feather-row">
      <div class="feather-col-12">
        <div class="card">
          ...
          <!-- eslint-disable-next-line vue/no-v-html -->
          <div v-html="DOMPurify.sanitize(alarm.operatorInstructions)" class="card__body"></div>
        </div>
      </div>
    </div>
