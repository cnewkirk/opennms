...
# ---------------------------------------------------------------------------
# Requisition XML lives at .topology-lab/Topology-Lab.xml so it can also be
# re-applied independently (after a test-opennms rebuild) via
# ./provision-topology-lab.sh — keeping a single source of truth.
echo ""
echo "==> [7/8] Provisioning topology nodes into OpenNMS..."
"${SCRIPT_DIR}/provision-topology-lab.sh"
